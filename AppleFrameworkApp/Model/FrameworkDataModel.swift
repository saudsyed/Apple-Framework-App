...
struct FrameworkDataModel : Hashable, Identifiable {
    let id = UUID()
    let name: String
...
struct FrameworkData {
    ...
    static let sampleFramework = FrameworkDataModel(name: "ARKit",
                                                    imageName: "arkit",
    ...
    static let frameworks = [
        FrameworkDataModel(name: "App Clips",
                           imageName: "app-clip",
        ...
        FrameworkDataModel(name: "ARKit",
                           imageName: "arkit",
                           urlString: "https://developer.apple.com/augmented-reality/arkit",
                           description: "ARKit 4 introduces a brand-new Depth API, creating a new way to access the detailed depth information gathered by the LiDAR Scanner on iPhone 12 Pro, iPhone 12 Pro Max, and iPad Pro.\n\nLocation Anchors leverages the higher-resolution data in Apple Maps to place AR experiences at a specific point in the world in your iPhone and iPad apps. And support for face tracking extends to all devices with the Apple Neural Engine and a front-facing camera, so even more users can experience the joy of AR in photos and videos."),
        
        FrameworkDataModel(name: "CarPlay",
                           imageName: "carplay",
        ...
        FrameworkDataModel(name: "Catalyst",
                           imageName: "catalyst",
        ...
        FrameworkDataModel(name: "ClassKit",
                           imageName: "classkit",
        ...
        FrameworkDataModel(name: "CloudKit",
                           imageName: "cloudkit",
        ...
        FrameworkDataModel(name: "Core ML",
                           imageName: "coreml",
        ...
        FrameworkDataModel(name: "HealthKit",
                           imageName: "healthkit",
        ...
        FrameworkDataModel(name: "SF Symbols",
        ...
        FrameworkDataModel(name: "SiriKit",
                           imageName: "sirikit",
        ...
        FrameworkDataModel(name: "SpriteKit",
                           imageName: "spritekit",
        ...
        FrameworkDataModel(name: "SwiftUI",
                           imageName: "swiftui",
        ...
        FrameworkDataModel(name: "Test Flight",
        ...
        FrameworkDataModel(name: "Wallet",
                           imageName: "wallet",
        ...
        FrameworkDataModel(name: "WidgetKit",
                           imageName: "widgetkit",
